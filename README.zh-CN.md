...
<tr><td><b>闭环学习</b></td><td>代理管理记忆并定期自我提醒。复杂任务后自动创建技能。技能在使用中自我改进。FTS5 会话搜索配合 LLM 摘要实现跨会话回溯。<strong>本地人生图谱记忆（PTG）——数据不出设备。</strong>兼容 <a href="https://agentskills.io">agentskills.io</a> 开放标准。</td></tr>
