...
export const en: Translations = {
  ...
  boot: {
    ready: 'RealityOS Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading RealityOS settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting RealityOS Desktop…'
    },
    errors: {
      backgroundExited: 'RealityOS background process exited.',
      backgroundExitedDuringStartup: 'RealityOS background process exited during startup.',
    ...
    failure: {
      title: "RealityOS couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your RealityOS backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update RealityOS',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting RealityOS Desktop.',
    ...
    native: {
      ...
      inputBody: 'RealityOS is waiting for your response.',
      turnDoneTitle: 'RealityOS finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to RealityOS defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones RealityOS writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while RealityOS is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'RealityOS asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while RealityOS was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let RealityOS follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what RealityOS is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen RealityOS, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'RealityOS checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading RealityOS configuration...',
    ...
    gateway: {
      ...
      intro:
        'RealityOS Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running RealityOS backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private RealityOS backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote RealityOS backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'RealityOS Cloud',
      cloudDesc: 'Sign in once to RealityOS Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'RealityOS Cloud',
      cloudSignIn: 'Sign in to RealityOS Cloud',
      cloudSignedIn: 'Signed in to RealityOS Cloud',
      cloudNeedsSignIn: 'Sign in to RealityOS Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your RealityOS Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'RealityOS Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of RealityOS Cloud',
      cloudSignedOutMessage: 'Cleared the RealityOS Cloud session.',
      ...
      restartingMessage: 'RealityOS Desktop will reconnect using the saved settings — the shell stays open.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. RealityOS runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As RealityOS builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart RealityOS to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update RealityOS to generate pets.',
      backgroundHint: 'You can close this — RealityOS will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure RealityOS desktop' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent RealityOS environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. RealityOS will run it and deliver results to the destination you pick.',
  ...
  memory: {
    ...
    errorDesc: 'Something went wrong reading your memory. Try again shortly.',
    refresh: 'Refresh',
    refreshing: 'Loading…',
    refreshHelp: 'Re-read the latest memories',
    emptyAtomsTitle: 'Nothing here yet',
    emptyAtomsDesc: 'The people, events, and states you mention will show up here.',
    emptyEntitiesTitle: 'No people yet',
    emptyEntitiesDesc: 'People, places, and organizations you mention are collected here.',
    emptyRelationsTitle: 'No relations yet',
    emptyRelationsDesc: 'Connections between people and entities will appear here.',
    typePerson: 'Person',
    typeTask: 'Task',
    typeExpression: 'Intent',
    typeCognition: 'Cognition',
    typeOutcome: 'Outcome',
    typeSelfState: 'State',
    typeEmotion: 'Emotion',
    typeEntity: 'Place/Org',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the RealityOS backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from RealityOS. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting RealityOS...',
    placeholderReconnecting: 'Reconnecting to RealityOS…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give RealityOS a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'RealityOS will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask RealityOS to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating RealityOS…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting RealityOS…',
    ...
    unsupportedMessage: 'This version of RealityOS can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of RealityOS is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected RealityOS backend is ready to install.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the RealityOS desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The RealityOS updater takes over in its own window and reopens RealityOS automatically when it’s done. Please don’t reopen RealityOS yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. RealityOS reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then RealityOS reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'RealityOS needs a one-time install',
    ...
    settingUpTitle: 'Setting up RealityOS Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another RealityOS CLI or desktop instance is running. Stop any running RealityOS instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The RealityOS installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with RealityOS Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'RealityOS is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting RealityOS…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run RealityOS',
    ...
    authorizeThere: 'Authorize RealityOS there.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'RealityOS inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'RealityOS is restarting...',
      askRestart: 'Ask RealityOS to restart the server',
      lookingRestart: taskId => `Hermes is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'RealityOS is working in the background. Watch the preview console for progress.',
      ...
      restartFailedMessage: 'RealityOS could not restart the server.',
      stillWorking:
        'RealityOS is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'RealityOS is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'RealityOS gateway is not connected',
  ...
  prompts: {
    ...
    sudoDesc: 'RealityOS needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'RealityOS needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart RealityOS Desktop to use Save Image.',
    restartToSaveImages: 'Restart RealityOS Desktop to save images',
