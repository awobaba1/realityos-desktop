...
export const ja = defineLocale({
  ...
  boot: {
    ready: 'RealityOS Desktop の準備ができました',
    desktopBootFailedWithMessage: message => `デスクトップの起動に失敗しました: ${message}`,
    steps: {
      connectingGateway: 'ライブデスクトップゲートウェイに接続中',
      loadingSettings: 'RealityOS の設定を読み込み中',
      loadingSessions: '最近のセッションを読み込み中',
      startingDesktopConnection: 'デスクトップ接続を開始中',
      startingHermesDesktop: 'RealityOS Desktop を起動中…'
    },
    errors: {
      backgroundExited: 'RealityOS バックグラウンドプロセスが終了しました。',
      backgroundExitedDuringStartup: '起動中に RealityOS バックグラウンドプロセスが終了しました。',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'RealityOS バックエンドがこのデスクトップビルドより古く、正常に動作しない場合があります。更新して揃えてください。',
    installMethodUnsupportedTitle: 'サポート対象外のインストール方法',
    updateHermes: 'RealityOS を更新',
    ...
    errors: {
      ...
      methodNotAllowed:
        'デスクトップバックエンドがそのリクエストを拒否しました (405 Method Not Allowed)。RealityOS Desktop を再起動してください。',
    ...
    native: {
      ...
      rejectAction: '拒否',
      inputTitle: '入力が必要です',
      inputBody: 'RealityOS が応答を待っています。',
      turnDoneTitle: 'RealityOS が完了しました',
  ...
  settings: {
    ...
    resetConfirm: 'すべての設定を RealityOS のデフォルトに戻しますか？',
    ...
    sovereignty: {
      title: 'データ主権',
      intro: 'あなたの記憶はあなただけのもの—いつでも書き出し、区間削除、未成年向けの収集ダウングレードが可能です。',
      exportTitle: 'データを書き出す',
      exportDesc: '記憶全体の JSON をワンクリック書き出し（PIPL §45 ポータビリティ）。',
      exportBtn: 'JSON を書き出し',
      exportFailed: '書き出しに失敗しました。少ししてから再試行してください。',
      deleteTitle: '記憶の区間を削除',
      deleteDesc: 'ソフト削除（1日以内なら開発者経由で復元可能）。物理消去は夜間メンテで別途実行されます。',
      deleteModeA: 'モード A：メモのみ',
      deleteModeADesc: '容量回収—生のメッセージのみ削除し、抽出済みの原子と関係は保持します。',
      deleteModeB: 'モード B：完全忘却',
      deleteModeBDesc: 'メッセージ + 原子 + エンティティ + 関係を削除（完全忘却）。',
      deleteBtn: '削除',
      deleteConfirmA: 'この期間のメッセージをソフト削除しますか？原子と関係は保持されます。',
      deleteConfirmB: 'この期間の記憶を完全に忘れますか？UI からは取り消せません。',
      deleteDone: summary => `ソフト削除完了：${summary}`,
      deleteFailed: '削除に失敗しました。少ししてから再試行してください。',
      deleteMarked: counts => `マーク済み：${counts}`,
      minorTitle: '未成年モード',
      minorDesc: 'オンにすると状態（R1）と感情（R9）の生体マーカー原子を記録しません。',
      minorOn: 'オン',
      minorOff: 'オフ',
      noData: 'まだ記憶がありません。数日使ってからまた来てください。',
      loadFailed: '設定の読み込みに失敗しました。少ししてから再試行してください。'
    },
    notifications: {
      title: '通知',
      ...
      focusedHint: '完了通知は RealityOS がバックグラウンドにあるときのみ表示されます。',
      kinds: {
        approval: {
          label: '承認が必要',
        ...
        input: {
          label: '入力が必要',
          description: 'RealityOS が質問したか、パスワードやシークレットを必要としています。'
        },
        turnDone: {
          label: '応答完了',
          description: 'RealityOS がバックグラウンドのときにターンが完了しました。'
        },
        turnError: {
          label: 'ターン失敗',
    ...
    appearance: {
      ...
      colorMode: 'カラーモード',
      colorModeDesc: '固定モードを選ぶか、RealityOS をシステム設定に合わせます。',
      ...
      pet: {
        title: 'ペット',
        intro:
          'アプリ上に浮かぶ petdex のアニメーションマスコットを採用しましょう。ツール実行中は走り、成功すると喜び、エラーでしょんぼりと、RealityOS の状態に反応します。',
        restartHint:
          'ペット機能には再起動が必要です。この機能が追加される前に起動したアプリが動作中です。RealityOS を終了して再度開き、このページに戻ってください。',
        scaleTitle: 'サイズ',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone:
        'RealityOS がローカル時刻のコンテキストを必要とするときに使用します。空欄ならシステムのタイムゾーンを使います。',
      agent: {
        imageInputMode: '画像添付をモデルへ送る方法を制御します。',
        maxTurns: 'RealityOS が 1 回の実行を停止するまでのツール呼び出しターン上限です。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'RealityOS が 1 回のファイル読み取りで取得できる最大文字数です。',
      approvals: {
        mode: '明示的な承認が必要なコマンドを RealityOS がどう扱うかを設定します。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'アプリから RealityOS 自身を更新するとき、ローカルのソース変更を保持するか破棄するかを選びます。ターミナル更新では常に確認されます。'
      }
    }),
    about: {
      ...
      automaticUpdatesDesc: 'RealityOS はバックグラウンドで自動的に更新を確認し、利用可能になったら通知します。',
    ...
    gateway: {
      ...
      intro:
        'RealityOS Desktop はデフォルトで独自のローカルゲートウェイを起動します。別のマシンや信頼できるプロキシの背後で既に動作している RealityOS バックエンドをこのアプリで制御する場合は、リモートゲートウェイを使用してください。以下でプロファイルを選択して、それぞれのリモートホストを設定します。',
      appliesTo: '適用対象',
      ...
      localDesc:
        'ローカルホストでプライベートな RealityOS バックエンドを起動します。これがデフォルトで、オフラインでも動作します。',
      remoteTitle: 'リモートゲートウェイ',
      remoteDesc:
        'このデスクトップシェルをリモートの RealityOS バックエンドに接続します。ホスト型ゲートウェイは OAuth またはユーザー名とパスワードを使用します。自己ホスト型はセッショントークンを使用する場合があります。',
      ...
      restartingMessage: 'RealityOS Desktop は保存された設定を使用して再接続します。',
    ...
    providers: {
      ...
      intro:
        'サブスクリプションでサインインします。API キーのコピーは不要です。RealityOS がアプリ内でブラウザーサインインを代行します。',
      connected: '接続済み',
      collapse: '折りたたむ',
  ...
  starmap: {
    ...
    emptyDesc: 'RealityOS がスキルやメモリを蓄積すると、ここに表示されます。'
  },
  agents: {
    close: 'エージェントを閉じる',
    title: 'スポーンツリー',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'ペット機能を使うには RealityOS を再起動してください。',
      empty: '一致するペットがありません。',
      turnOff: 'オフ',
      turnOn: 'オン',
      installed: 'インストール済み',
    ...
    generatePet: {
      ...
      staleBackend: 'ペットを生成するには RealityOS を更新してください。',
      backgroundHint: 'このウィンドウは閉じても大丈夫です。完了したら RealityOS が通知します。',
    ...
    nav: {
      ...
      settings: { title: '設定', detail: 'RealityOS デスクトップを設定' },
  ...
  profiles: {
    ...
    deleting: '削除中...',
    createDesc: 'プロファイルは独立した RealityOS 環境です：設定、スキル、SOUL.md が別々になります。',
    nameLabel: '名前',
    cloneFrom: '複製元',
    cloneFromNone: 'なし（空）',
  ...
  cron: {
    ...
    newCron: '新しい Cron',
    emptyDescNew:
      'Cron 式でプロンプトを実行するスケジュールを設定します。RealityOS が実行して、選択した宛先に結果を送信します。',
  ...
  memory: {
    ...
    errorTitle: '開けません',
    errorDesc: '記憶の読み込みで問題が起きました。少し後に再試行してください。',
    refresh: '更新',
    refreshing: '読み込み中…',
    refreshHelp: '最新の記憶を再読み込み',
    emptyAtomsTitle: 'まだ何もありません',
    emptyAtomsDesc: '話した人、出来事、状態がここに表示されます。',
    emptyEntitiesTitle: 'まだ人物がいません',
    emptyEntitiesDesc: '言及した人、場所、組織がここにまとまります。',
    emptyRelationsTitle: 'まだ関係がありません',
    emptyRelationsDesc: '人物とエンティティのつながりがここに表示されます。',
    typePerson: '人物',
    typeTask: 'タスク',
    typeExpression: '意図',
    typeCognition: '認知',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'プロジェクトを作成するには RealityOS バックエンドを更新してください。バックエンドがこのデスクトップアプリより古いです（設定 → 更新 → バックエンド）。',
      deleteConfirm:
        'RealityOS から保存済みプロジェクトを削除します。ファイル・git リポジトリ・ワークツリーはそのまま残ります。',
      startWork: '新しいワークツリー',
  ...
  composer: {
    ...
    placeholderStarting: 'RealityOS を起動中...',
    placeholderReconnecting: 'RealityOS に再接続中…',
    ...
    attachUrlDesc: 'RealityOS がページを取得し、このターンのコンテキストとして含めます。',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'RealityOS にコミットと PR を任せる',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'もうすぐ完了…',
      pydeps: '仕上げ中…',
      update: 'RealityOS を更新中…',
      rebuild: 'デスクトップアプリを再ビルド中…',
      restart: 'RealityOS を再起動中…',
      done: '更新が完了しました',
      manual: 'ターミナルから更新',
    ...
    unsupportedMessage: 'このバージョンの RealityOS はアプリ内から自分を更新できません。',
    ...
    availableBody: '新しいバージョンの RealityOS をインストールする準備ができています。',
    availableTitleBackend: 'バックエンドの更新があります',
    availableBodyBackend: '接続中の RealityOS バックエンドの新しいバージョンをインストールできます。',
    ...
    manualBody:
      'RealityOS をコマンドラインからインストールしたため、更新もそこで実行されます。これをターミナルに貼り付けてください:',
    manualPickedUp: 'RealityOS は次回起動時に新しいバージョンを読み込みます。',
    guiSkewTitle: 'デスクトップアプリを更新してください',
    guiSkewBody:
      'バックエンドは更新されましたが、このデスクトップアプリのパッケージは変更されていません。一致させるために RealityOS デスクトップアプリ（AppImage / .deb / .rpm）を更新または再インストールしてください。',
    copy: 'コピー',
    copied: 'コピーしました',
    done: '完了',
    applyingBody:
  ...
  install: {
    ...
    oneTimeTitle: 'RealityOS には一度限りのインストールが必要です',
    ...
    settingUpTitle: 'RealityOS Agent を設定中',
    finishingTitle: '仕上げ中',
    failedDesc:
      'インストール手順のいずれかが失敗しました。Windows では、別の RealityOS CLI またはデスクトップインスタンスが実行中の場合に発生することがあります。実行中の RealityOS インスタンスをすべて停止してから再試行してください。詳細は以下またはデスクトップログで確認できます。',
    activeDesc:
      'これは一回限りのセットアップです。RealityOS インストーラーが依存関係をダウンロードしてマシンを設定しています。以降の起動ではこの手順はスキップされます。',
  ...
  onboarding: {
    headerTitle: 'RealityOS Agent のセットアップをしましょう',
    headerDesc: 'チャットを始めるにはモデルプロバイダーを接続してください。ほとんどのオプションはワンクリックです。',
    preparingInstall: 'RealityOS はインストールを完了中です。初回実行では通常 1 分以内に完了します。',
    starting: 'RealityOS を起動中…',
    ...
    recommended: '推奨',
    connected: '接続済み',
    featuredPitch: '1 つのサブスクリプションで 300 以上の最先端モデル — RealityOS を実行するための推奨方法',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'セルフホスト',
        description:
          'ローカルまたはセルフホストの OpenAI 互換エンドポイント（vLLM、llama.cpp、Ollama など）に RealityOS を接続。'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'ブラウザーで確認ページを開きます — RealityOS が自動接続します',
    ...
    authorizeThere: 'そこで RealityOS を承認してください。',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'RealityOS 推論ゲートウェイのステータス',
      agents: 'エージェント',
  ...
  preview: {
    ...
    web: {
      ...
      tryAgain: '再試行',
      restarting: 'RealityOS を再起動中...',
      askRestart: 'RealityOS にサーバーの再起動を依頼',
      lookingRestart: taskId => `Hermes は再起動するプレビューサーバーを検索中です (${taskId})`,
      restartingTitle: 'プレビューサーバーを再起動中',
      restartingMessage: 'RealityOS はバックグラウンドで作業中です。進捗はプレビューコンソールで確認してください。',
      ...
      restartFailedMessage: 'RealityOS がサーバーを再起動できませんでした。',
      stillWorking:
        'RealityOS はまだ作業中ですが、再起動の結果がまだ届いていません。サーバーコマンドがフォアグラウンドで実行されている可能性があります。',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'RealityOS が応答を読み込み中',
    ...
    approval: {
      gatewayDisconnected: 'RealityOS ゲートウェイが接続されていません',
  ...
  prompts: {
    ...
    sudoTitle: '管理者パスワード',
    sudoDesc:
      'RealityOS は特権コマンドを実行するために sudo パスワードが必要です。ローカルエージェントにのみ送信されます。',
    sudoPlaceholder: 'sudo パスワード',
    secretTitle: 'シークレットが必要です',
    secretDesc: 'RealityOS は続行するための認証情報が必要です。',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '画像を保存するには RealityOS Desktop を再起動してください。',
    restartToSaveImages: '画像を保存するには RealityOS Desktop を再起動してください',
